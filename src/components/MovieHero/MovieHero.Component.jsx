...
const MovieHero = () => {
    ...
    return (
        ...
        <div className="relative hidden w-full lg:block" style={{height: "30rem"}}>
            ...
            style={{backgroundImage: "linear-gradient(90deg, rgb(34,34,34) 14.95%, rgba(34,34,34) 30.3%, rgba(34,34,34,0.90) 38.3%, rgba(34,34,34,0.60) 58.3%, rgba(34,34,34,0.04) 100%)"}}
             />
